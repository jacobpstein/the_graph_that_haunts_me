...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width=14, fig.height=10, out.width="100%"}
...
```{r, message = FALSE, warning = FALSE, fig.width=14, fig.height=10, out.width="100%"}
...
## {background-image="court.jpeg"}{.r-fit-text}
